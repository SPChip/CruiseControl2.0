...
#define ACCEL_DAC_ADDR_I2C 0x60    // адрес ЦАП управления газом по шине I2C
#define BRAKE_DAC_ADDR_I2C 0x61    // адрес ЦАП управления тормозом по шине I2C
#define MIN_REGULATOR_OUT 20       // минимум на выходе регулятора ПИД
#define MAX_REGULATOR_OUT 350      // максимум на выходе регулятора ПИД
#define ITERATION_TIME 10          // время итерации ПИДа (как часто производится расчет, в мс)
...
GyverPID REGULATOR(0, 0, 0, ITERATION_TIME);      // создаем регулятор PID
